...
from .sirius_parkour_config import LeggedRobotCfg
from .sirius_parkour_config import SiruisParkourCfg
...
class LeggedRobot(BaseTask):
    ...
    def _init_buffers(self):
        ...
        self.commands_scale = torch.tensor([self.obs_scales.lin_vel, self.obs_scales.lin_vel, self.obs_scales.ang_vel],
                                           device=self.device, requires_grad=False, )  # TODO: tune scales
    ...
    def _draw_feet(self):
        if hasattr(self, 'feet_at_edge'):
            non_edge_geom = gymutil.WireframeSphereGeometry(0.02, 16, 16, None, color=(0, 1, 0)) # 绿色
            edge_geom = gymutil.WireframeSphereGeometry(0.02, 16, 16, None, color=(1, 0, 0)) # 红色
    ...
    def _create_envs(self):
        ...
        print(colorama.Fore.CYAN + "feet_names")
        print(feet_names)

        # Notes: 固定了foot name和顺序
        for s in ["RF_FOOT", "LF_FOOT", "RH_FOOT", "LH_FOOT"]: # 逆时针顺序 ETH
